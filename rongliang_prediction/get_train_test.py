...
if __name__ == '__main__':
    ...
    total_data1 = total_data[-total_data[u'申请执行月'].isin([20160401, 20160501])]

    total_data1.to_csv(train,encoding='gbk')
    total_data2 = total_data[total_data[u'申请执行月'].isin([20160401, 20160501])]
    total_data2.to_csv(test,encoding='gbk')